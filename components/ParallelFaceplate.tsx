...
export const ParallelFaceplate: React.FC<FaceplateProps> = ({ type, data, onClose, onAction }) => {
    ...
    const displayStatus = compName === 'staticSwitch' ? (data.mode || 'UNKNOWN') : (data.status || 'UNKNOWN');
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center gap-4 mb-6 bg-slate-900/50 p-3 rounded border border-slate-700">
                        ...
                        <div className="flex-1">
                            <div className="text-[10px] text-slate-500 uppercase">{compName === 'staticSwitch' ? 'Active Source' : 'Current Status'}</div>
