        ...
        <div className="flex-1 flex flex-col p-0 h-full min-h-0 relative">
            ...
            <div className="flex-none flex justify-between items-center bg-slate-900 border-b border-cyan-500/20 shadow-lg z-10 px-4 py-2 h-20">
                 <div className="flex flex-col justify-center">
                     <h1 className="text-xl font-black italic text-slate-100 tracking-tighter leading-none">OMNI<span className="text-cyan-500">POWER</span></h1>
                     <div className="text-[10px] text-slate-400 font-mono tracking-widest mt-1">DIGITAL TWIN v2.5</div>
                 </div>
            ...
            {/* Reduced height to h-36 to give more room to SLD */}
